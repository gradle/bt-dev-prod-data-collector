...
public class BuildRecord extends UpdatableRecordImpl<BuildRecord> implements Record10<String, String, String, Long, OffsetDateTime, OffsetDateTime, String, String, Integer, String> {
    ...
    @Override
    public Row10<String, String, String, Long, OffsetDateTime, OffsetDateTime, String, String, Integer, String> valuesRow() {
    ...
    @Override
    public BuildRecord values(String value1, String value2, String value3, Long value4, OffsetDateTime value5, OffsetDateTime value6, String value7, String value8, Integer value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BuildRecord(String buildId, String rootProject, String pathToFirstTestTask, Long timeToFirstTestTask, OffsetDateTime buildStart, OffsetDateTime buildFinish, String username, String host, Integer daemonAge, String daemonUnhealthyReason) {
        super(Build.BUILD);
