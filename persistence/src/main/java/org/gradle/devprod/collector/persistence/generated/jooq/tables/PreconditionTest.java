...
public class PreconditionTest extends TableImpl<PreconditionTestRecord> {
     ...
     */
    public final TableField<PreconditionTestRecord, String[]> PRECONDITIONS = createField(DSL.name("preconditions"), SQLDataType.CLOB.nullable(false).array(), this, "");
    ...
    public List<ForeignKey<PreconditionTestRecord, ?>> getReferences() {
        return Arrays.asList(Keys.PRECONDITION_TEST__PRECONDITION_TEST_BUILD_ID_FKEY);
    }
    ...
    @Override
    public PreconditionTest as(Table<?> alias) {
        return new PreconditionTest(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public PreconditionTest rename(Table<?> name) {
        return new PreconditionTest(name.getQualifiedName(), null);
    }
