...
public class TeamcityBuildRecord extends UpdatableRecordImpl<TeamcityBuildRecord> implements Record11<String, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, String, String, String, String, String, String[]> {
    ...
    @Override
    public Row11<String, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, String, String, String, String, String, String[]> fieldsRow() {
        return (Row11) super.fieldsRow();
    }

    @Override
    public Row11<String, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, String, String, String, String, String, String[]> valuesRow() {
    ...
    @Override
    public TeamcityBuildRecord values(String value1, String value2, OffsetDateTime value3, OffsetDateTime value4, OffsetDateTime value5, String value6, String value7, String value8, String value9, String value10, String[] value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TeamcityBuildRecord(String buildId, String configuration, OffsetDateTime queued, OffsetDateTime started, OffsetDateTime finished, String state, String status, String statusText, String branch, String gitCommitId, String[] buildscanUrls) {
        super(TeamcityBuild.TEAMCITY_BUILD);
