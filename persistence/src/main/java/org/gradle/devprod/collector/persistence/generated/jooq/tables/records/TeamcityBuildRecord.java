...
public class TeamcityBuildRecord extends UpdatableRecordImpl<TeamcityBuildRecord> implements Record16<String, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, String, String, String, String, String, String[], Boolean, String, String, OffsetDateTime, Boolean> {
    ...
    /**
     * Setter for <code>public.teamcity_build.dependency_finished</code>.
     */
    public void setDependencyFinished(OffsetDateTime value) {
        set(14, value);
    }

    /**
     * Getter for <code>public.teamcity_build.dependency_finished</code>.
     */
    public OffsetDateTime getDependencyFinished() {
        return (OffsetDateTime) get(14);
    }

    /**
     * Setter for <code>public.teamcity_build.has_retried_build</code>.
     */
    public void setHasRetriedBuild(Boolean value) {
        set(15, value);
    }

    /**
     * Getter for <code>public.teamcity_build.has_retried_build</code>.
     */
    public Boolean getHasRetriedBuild() {
    ...
    @Override
    public Row16<String, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, String, String, String, String, String, String[], Boolean, String, String, OffsetDateTime, Boolean> fieldsRow() {
        return (Row16) super.fieldsRow();
    }

    @Override
    public Row16<String, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, String, String, String, String, String, String[], Boolean, String, String, OffsetDateTime, Boolean> valuesRow() {
    ...
    public Field<OffsetDateTime> field15() {
        return TeamcityBuild.TEAMCITY_BUILD.DEPENDENCY_FINISHED;
    }

    @Override
    public Field<Boolean> field16() {
        return TeamcityBuild.TEAMCITY_BUILD.HAS_RETRIED_BUILD;
    }
    ...
    public OffsetDateTime component15() {
        return getDependencyFinished();
    }

    @Override
    public Boolean component16() {
        return getHasRetriedBuild();
    }
    ...
    @Override
    public TeamcityBuildRecord value15(OffsetDateTime value) {
        setDependencyFinished(value);
        return this;
    }

    @Override
    public TeamcityBuildRecord value16(Boolean value) {
        setHasRetriedBuild(value);
        return this;
    }

    @Override
    public TeamcityBuildRecord values(String value1, String value2, OffsetDateTime value3, OffsetDateTime value4, OffsetDateTime value5, String value6, String value7, String value8, String value9, String value10, String[] value11, Boolean value12, String value13, String value14, OffsetDateTime value15, Boolean value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TeamcityBuildRecord(String buildId, String configuration, OffsetDateTime queued, OffsetDateTime started, OffsetDateTime finished, String state, String status, String statusText, String branch, String gitCommitId, String[] buildscanUrls, Boolean composite, String buildHostName, String buildHostType, OffsetDateTime dependencyFinished, Boolean hasRetriedBuild) {
        super(TeamcityBuild.TEAMCITY_BUILD);
        ...
        setDependencyFinished(dependencyFinished);
        setHasRetriedBuild(hasRetriedBuild);
