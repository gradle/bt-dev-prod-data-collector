...
public class TeamcityBuildRecord extends UpdatableRecordImpl<TeamcityBuildRecord> implements Record11<String, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, String, String, String, String, String, Double> {
    ...
    /**
     * Setter for <code>public.teamcity_build.pre_tested_commit_success_rate</code>.
     */
    public void setPreTestedCommitSuccessRate(Double value) {
        set(10, value);
    }

    /**
     * Getter for <code>public.teamcity_build.pre_tested_commit_success_rate</code>.
     */
    public Double getPreTestedCommitSuccessRate() {
    ...
    @Override
    public Row11<String, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, String, String, String, String, String, Double> valuesRow() {
    ...
    public Field<Double> field11() {
        return TeamcityBuild.TEAMCITY_BUILD.PRE_TESTED_COMMIT_SUCCESS_RATE;
    }
    ...
    public Double component11() {
        return getPreTestedCommitSuccessRate();
    }
    ...
    @Override
    public TeamcityBuildRecord value11(Double value) {
        setPreTestedCommitSuccessRate(value);
        return this;
    }

    @Override
    public TeamcityBuildRecord values(String value1, String value2, OffsetDateTime value3, OffsetDateTime value4, OffsetDateTime value5, String value6, String value7, String value8, String value9, String value10, Double value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TeamcityBuildRecord(String buildId, String configuration, OffsetDateTime queued, OffsetDateTime started, OffsetDateTime finished, String state, String status, String statusText, String branch, String gitCommitId, Double preTestedCommitSuccessRate) {
        super(TeamcityBuild.TEAMCITY_BUILD);
        ...
        setPreTestedCommitSuccessRate(preTestedCommitSuccessRate);
    }
}
