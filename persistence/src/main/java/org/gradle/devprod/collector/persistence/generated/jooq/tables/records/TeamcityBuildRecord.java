...
public class TeamcityBuildRecord extends UpdatableRecordImpl<TeamcityBuildRecord> implements Record12<String, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, String, String, String, String, String, String[], Boolean> {
    ...
    @Override
    public Row12<String, String, OffsetDateTime, OffsetDateTime, OffsetDateTime, String, String, String, String, String, String[], Boolean> valuesRow() {
    ...
    @Override
    public TeamcityBuildRecord values(String value1, String value2, OffsetDateTime value3, OffsetDateTime value4, OffsetDateTime value5, String value6, String value7, String value8, String value9, String value10, String[] value11, Boolean value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TeamcityBuildRecord(String buildId, String configuration, OffsetDateTime queued, OffsetDateTime started, OffsetDateTime finished, String state, String status, String statusText, String branch, String gitCommitId, String[] buildscanUrls, Boolean composite) {
        super(TeamcityBuild.TEAMCITY_BUILD);
